 ...
 * dashboard.
 */
export default function TotalsCard({ ventas, pedidos, ventaPromedio, unidades }) {
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-3.5">
            ...
            <StatCard icon={faTicket} label="Promedio de venta" value={ventaPromedio} tone="violet" delay={120} />
