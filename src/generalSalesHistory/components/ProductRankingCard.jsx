                ...
                <ul className="flex flex-col gap-3">
                    {items.map((item, i) => (
                        <li key={item.nombre} className="flex items-center gap-3">
                            ...
                            <span className="flex-1 min-w-0 truncate text-sm sm:text-base text-slate-700">{item.nombre}</span>
                            <span className="shrink-0 text-sm sm:text-base font-bold text-slate-800">{item.cantidad} u.</span>
                        </li>
                    ))}
                </ul>
            )}
