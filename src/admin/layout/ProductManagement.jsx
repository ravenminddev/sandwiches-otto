        ...
        <section className="relative flex flex-col gap-5 pb-24">
            ...
            <div className="flex flex-col gap-3 animate-rise">
                <div className="inline-flex items-center gap-2">
                    <h2 className="text-[22px] sm:text-[24px] font-bold text-gray-900">
                        Catálogo
                    </h2>
                    {totalProductos > 0 && (
                ...
                <div className="relative">
                    <FontAwesomeIcon
                        ...
                        className="absolute left-3.5 top-1/2 -translate-y-1/2 text-dash-gray-soft text-sm pointer-events-none"
                    />
                    <input
                        type="text"
                        value={search}
                        ...
                        className="w-full h-11 pl-10 pr-4 rounded-xl bg-white border border-dash-border/60 text-[13px] text-dash-ink placeholder:text-dash-gray-soft focus:outline-none focus:border-yellow-otto focus:ring-2 focus:ring-yellow-otto/15 transition-all"
                    />
                </div>
            </div>

            {totalProductos > 0 && productosFiltrados.length === 0 ? (
                <div className="text-center py-14 text-dash-gray animate-fade-in">
